...
// Helper function: same as GamePage selectCards
...
describe('Card Initialization', () => {
  ...
  it('should initialize exactly 28 cards for 3x3 to 9x9', () => {
    const cards = StorageService.initializeCards()
...
describe('Card Filtering', () => {
  ...
  beforeEach(() => {
    localStorage.clear()
    allCards = StorageService.initializeCards()
  })
...
describe('Integration: Full Game Flow', () => {
  ...
  it('should correctly filter and select cards for [6]', () => {
    const allCards = StorageService.initializeCards()
    const select = [6]
